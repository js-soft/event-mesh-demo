interface ZIF_ENTRY_CREATE_V1_6EF5
  public .
  ...
  types:
    TY_S_ENTRY_CREATE_V1 TYPE STRUCTURE FOR HIERARCHY Z_entry_create_v1_1E69 .

  methods GET_BUSINESS_DATA
    returning
      value(RS_BUSINESS_DATA) type ty_s_entry_create_v1
    raising
      /IWXBE/CX_EXCEPTION .
endinterface.
